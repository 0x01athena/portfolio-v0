  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <a
            href="https://drive.google.com/file/d/18NuBnRAYXfz09OukwYPiF3HsLS8z4Zzn/view?usp=sharing"
            target="_blank"
          ...
          >
            ...
            >
              <FaTelegram className="text-2xl md:text-3xl lg:text-4xl hover:text-teal-500" />
            </motion.a>
            <motion.a
              variants={iconVariants}
